...
{
    public record GetWalletTransactionsQuery(GetWalletTransactionsRequest GetWalletTransactionsRequest) : IRequest<ServiceResponse<GetWalletTransactionsResponse>>;
}
